...
|204 No Content |SUCCESS |Logout successful
|401 Unauthorized |INVALID_TOKEN |Token missing or invalid
|500 Internal Server Error |SERVER_ERROR |Unexpected error occurred
|===
